...
export default function Footer() {
  return (
    <footer className="bg-[#0e100f]">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center gap-x-6 mb-5 md:order-2">
          {navigation.map((item) => (
            <a key={item.name} href={item.href} className="text-amber-50 hover:text-gray-300">
              <span className="sr-only">{item.name}</span>
              <item.icon aria-hidden="true" className="size-6" />
            </a>
          ))}
        </div>
        <p className="mt-8 mb-5 text-center text-sm/6 text-amber-50 md:order-1 md:mt-0">
